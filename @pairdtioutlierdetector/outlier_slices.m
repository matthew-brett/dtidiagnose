...
% Detect bad slices using paired slice outlier method
if nargin < 3
  detector = [];
end

% Calculate distances, ratios
[pairs dists rats] = paired_slice_distances(o, dtis);

out_slices = outlier_dist_rats(o, dists, rats, length(dtis), detector);
return

function out_slices = lslsl(o, dists, rats, nvols, detector)
